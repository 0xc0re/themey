/*
    Resolve dropped files to dock launchers without the private taskmanager
    Backend. .desktop / applications: -> pin that app (prefer a system
    applications: id). Other files -> pin the default handler for their
    MIME type.
...
function readTextFile(path) {
    ...
    try {
        ...
        console.warn("launcherfromdrop: cannot read", url, e);
    }
    return "";
}
